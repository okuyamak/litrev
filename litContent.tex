...
\begin{itemize}	
	\item{\bf Stafford(2003) -- around 50 years-- Cross-sectional -- Int J Epidemiol} 
		\begin{description}
			...
			\item[Findings] \mbox{}\par
				\begin{itemize}
					\item The difference for self-rated health, mental health, and waist/hip ratio between individual SES were greater in more deprived neighborhood based on multiplicative model although the interactions were not statistically significant.
					\item Those with low SES living in poor areas had higher financial problems than those with low SES living in affluent areas: the hypothesis wass not right.
				\end{itemize}
			\item[Strengths] \mbox{}\par
				\begin{itemize}
					\item Some additional measures: financial problem, neighborhood problem, dissatisfactions of stanard of living, and self-identified social position were investigated.
				\end{itemize}
			\item[Limitations] \mbox{}\par
				\begin{itemize}
					\item Cross-sectional associations.
					\item Individual SES was only based on employment type.
				\end{itemize}
			\item[Significance]\mbox{}\par
				\begin{itemize}
					\item Investigated how individual and neighborhood SES interact and affect on health.
				\end{itemize}
...
\begin{itemize}	
	\item{\bf Roux(2001) -- 45 to 64 years-- Longitudinal -- New En J Med} 
		\begin{description}
			...
			\item[Findings] \mbox{}\par
				\begin{itemize}
					\item Those living in deprived neighborhood had higher risk of developing CHD.
				\end{itemize}
			\item[Strengths] \mbox{}\par
				\begin{itemize}
					\item Detailed information for CHD.
				\end{itemize}
			\item[Limitations] \mbox{}\par
				\begin{itemize}
					\item Neighborhood was block group.
					\item Change of residence over time was not taken into account.
				\end{itemize}
			\item[Significance]\mbox{}\par
				\begin{itemize}
					\item Identfied the independent risk of neighborhood SES on coronary heart disease.
					\item The finding suggests that approach from person oritented and neighborhood oriented, i.e. changing residential environment is needed.
				\end{itemize}
			...
			\item[Takeaways] \mbox{}\par
				\begin{itemize}
					\item[$\clubsuit$] The relation between the characteristics of a neighborhood and health outcomes appears to be independent ofthe SES of indivual from many studies already as of 2000.
				\end{itemize}
		\end{description}
